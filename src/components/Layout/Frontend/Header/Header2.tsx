...
const Header2 = () => {
  ...
  return (
    <>
      ...
      />
      <div
        className={`${styles.ic_header_wrapper} ${styles.ic_header2_wrapper}  ic_header_wrap ic_header2_wrap`}
      >
              ...
              <ul className={styles.ic_navbar_nav}>
                ...
                <li className={styles.ic_nav_item}>
                  <Link
                    href="#"
                    className={`${styles.ic_nav_link} ${
                      pathname === "/listing" && styles.active
                    }`}
                ...
                <li className={styles.ic_nav_item}>
                  <Link
                    href="/dashboard"
                    className={`${styles.ic_nav_link} ${styles.ic_nav_link_btn} ic_btn ic_btn_xl`}
                  >
                    Dashboard
                  </Link>
                </li>
